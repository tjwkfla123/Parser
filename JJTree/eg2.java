...
class eg2/*@bgen(jjtree)*/implements eg2TreeConstants, eg2Constants {/*@bgen(jjtree)*/
  protected static JJTeg2State jjtree = new JJTeg2State();public static void main(String args[]) {
    ...
    try {
      ...
      n.printExpr();
      System.out.println("\u005cnThe binary tree representation of the reduced expression:");
      n.reduce();
      n.dump(" ");
  ...
  static final public void SubtractiveExpression() throws ParseException {
 ...
 /*@bgen(jjtree) MyID */
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x4000,0x8000,0x10000,0x20000,0x40000,0x80880,};
   }
