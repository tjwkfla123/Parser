...
class SimpleNode implements Node {
  ...
  public void dump(String prefix) {
    if (toString() != "Start") System.out.println(toString(prefix));
    if (children != null) {
  ...
  public void printExpr() {
    if (children != null) {
      for (int i = 0; i < children.length; ++i) {
        ...
        if (n != null) {
          if (i == 0) {
            if (children.length != 1) System.out.print(" ("); 
            n.printExpr();
          } else{
            n.printExpr();
            System.out.print(") ");
    ...
    } else System.out.print("" + toString() + " ");    
  }   
...
/* JavaCC - OriginalChecksum=342c25ce1ecd47a0e70d19c40ec603b6 (do not edit this line) */
